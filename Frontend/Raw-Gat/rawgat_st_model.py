...
class SincConv(nn.Module):
    ...
    def forward(self, x):
        ...
        band_pass = band_pass / (2 * band[:, None] + 1e-7)  # Add epsilon
...
class ResBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        if out.shape != identity.shape:
            ...
            # If still not matching (due to conv padding), adjust
...
class RawGAT_ST(nn.Module):
    def __init__(self, num_classes=2):
        ...
        # Spectro-temporal fusion and attention
        ...
        # Apply LeCun normal initialization for SELU compatibility
        self._init_weights()
    ...
    def forward(self, x):
        ...
        # Match dimensions for fusion (pad or interpolate)
        target_nodes = 12
